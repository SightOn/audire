...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    private func setDefaultDataset()
    {
        database.DeleteAll()
        ...
        database.CreateTestData(audioPath, dataName: "06月09日", userId: 1, tags: ["水", "癒やし"], voiceTags: [""], createDate: calendar.date(era: 1, year: 2017, month: 6, day: 9, hour: 20, minute: 26, second: 0, nanosecond: 0)!)
        database.Add()
        
        audioPath = "akihabara_lunch.m4a" //Bundle.main.path(forResource: "akihabara_lunch", ofType:"m4a")!
        database.CreateTestData(audioPath, dataName: "06月11日 秋葉原", userId: 1, tags: ["ランチ"], voiceTags: [""], createDate: calendar.date(era: 1, year: 2017, month: 6, day: 11, hour: 14, minute: 26, second: 0, nanosecond: 0)!)
        database.Add()
        
        audioPath = "on_the_bridge.m4a" //Bundle.main.path(forResource: "on_the_bridge", ofType:"m4a")!
        database.CreateTestData(audioPath, dataName: "06月11日 勝どき", userId: 1, tags: ["風"], voiceTags: [""], createDate: calendar.date(era: 1, year: 2017, month: 6, day: 11, hour: 19, minute: 26, second: 0, nanosecond: 0)!)
        database.Add()
        
        audioPath = "ginza_east.m4a" //Bundle.main.path(forResource: "ginza_east", ofType:"m4a")!
        database.CreateTestData(audioPath, dataName: "06月18日 東銀座", userId: 1, tags: ["話し声", "信号"], voiceTags: [""], createDate: calendar.date(era: 1, year: 2017, month: 6, day: 18, hour: 13, minute: 26, second: 0, nanosecond: 0)!)
        database.Add()
        
        audioPath = "on_stair.m4a" //Bundle.main.path(forResource: "on_stair", ofType:"m4a")!
        database.CreateTestData(audioPath, dataName: "06月20日 大崎", userId: 1, tags: ["階段"], voiceTags: [""], createDate: calendar.date(era: 1, year: 2017, month: 6, day: 10, hour: 11, minute: 26, second: 0, nanosecond: 0)!)
        database.Add()
        
        audioPath = "yurakucho_muzhirusi.m4a" //Bundle.main.path(forResource: "yurakucho_muzhirusi", ofType:"m4a")!
        database.CreateTestData(audioPath, dataName: "08月08日 有楽町", userId: 1, tags: ["お祭り", "夜"], voiceTags: [""], createDate: calendar.date(era: 1, year: 2017, month: 8, day: 8, hour: 20, minute: 26, second: 0, nanosecond: 0)!)
        database.Add()
    }
